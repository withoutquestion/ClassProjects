                ...
                <div class='container'>
                    <div class='span10 offset1'>
                        ...
                        <div class='row'>
							...
							<form action='/~tjpeltie/cis355/teecourses/ObjectCRUD/createTable.php'>
								<input type='submit' class='btn btn-primary' value='Go to courses' />
							</form>
							<form action='/~tjpeltie/cis355/teerounds/ObjectCRUD/createTable.php'>
								<input type='submit' class='btn btn-primary' value='Go to rounds' />
							</form>
